    ...
    return (
        ...
        <div className="flex mt-10 justify-between gap-10 screen">
            <div className="py-5 px-10 w-[45%] bg-red-400 rounded-xl">
                <h2 className="text-slate-300 text-3xl font-semibold bg-red-400">{data.tasks.newTask}</h2>
            ...
            <div className="py-5 px-10 w-[45%] bg-green-400 rounded-xl">
                <h2 className="text-slate-300 text-3xl font-semibold bg-green-400 ">{data.tasks.completed}</h2>
            ...
            <div className="py-5 px-10 w-[45%] bg-blue-400 rounded-xl">
                <h2 className="text-slate-300 text-3xl font-semibold bg-blue-400">{data.tasks.failed}</h2>
            ...
            <div className="py-5 px-10 w-[45%] bg-yellow-400 rounded-xl">
                <h2 className="text-slate-300 text-3xl font-semibold bg-yellow-400">{data.tasks.active}</h2>
